...
<@a.basis>
    <div class="container" style="margin-top:50px;">
        <div class="clearfix">
            ...
            <a class=" mt-1  btn btn-dark" href="/manager/orders/add" role="button">Добавить заказ</a>
        </span>
        </div>
        <ul class="nav nav-tabs justify-content-center mt-2" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#acceepted">Принятые заказы</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#cancel">Отмененные</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#finish">Завершенные</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="container tab-pane active" id="accepted"><br>
            ...
            <div class="container tab-pane" id="wait"><br>
                <table class="table" style="text-align: center ;margin-top: 30px ">
                    <thead>
                    <tr>
                        <th scope="col">Номер заказа</th>
            ...
            <div class="container tab-pane fade" id="cancel"><br>
                <table class="table" style="text-align: center ;margin-top: 30px ">
                    <thead>
                    <tr>
                        <th scope="col">Номер заказа</th>
            ...
            <div class="container tab-pane fade" id="finish"><br>
                <table class="table" style="text-align: center ;margin-top: 30px ">
                    <thead>
                    <tr>
                        <th scope="col">Номер заказа</th>
